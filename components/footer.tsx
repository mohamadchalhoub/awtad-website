...
This message was sent from the AWTAD website contact form.`
  ...
  return (
    <>
      <footer className="py-16 px-6 bg-gradient-to-b from-secondary/30 to-secondary/80 border-t border-border">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2 space-y-4">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 gold-gradient rounded-sm flex items-center justify-center shadow-lg glow-gold">
                  <span className="text-black font-mono font-bold text-lg">A</span>
                </div>
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="w-10 h-10 bg-primary/10 hover:bg-primary/20 border border-primary/20 rounded-lg flex items-center justify-center text-primary hover:text-primary/80 transition-all duration-300 hover:scale-110"
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-mono font-semibold text-foreground mb-4">Contact Info</h3>
            ...
            {/* Quick Links */}
            <div className="space-y-4">
              <h3 className="text-lg font-mono font-semibold text-foreground mb-4">Quick Links</h3>
              <div className="space-y-3">
